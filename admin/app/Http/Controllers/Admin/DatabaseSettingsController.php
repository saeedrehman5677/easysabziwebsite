...
class DatabaseSettingsController extends Controller
{
    ...
    public function databaseIndex(): View|Factory|Application
    {
        ...
        $filterTables = array('admins', 'admin_roles', 'branches', 'business_settings', 'email_verifications', 'failed_jobs', 'migrations', 'oauth_access_tokens', 'oauth_auth_codes', 'oauth_clients', 'oauth_personal_access_clients', 'oauth_refresh_tokens', 'password_resets', 'phone_verifications', 'soft_credentials', 'users', 'currencies', 'colors');
