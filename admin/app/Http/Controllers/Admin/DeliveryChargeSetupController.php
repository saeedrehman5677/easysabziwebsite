...
{}
    ...
    public function freeDeliveryOverAmountSetup(Request $request)
    {
        ...
        $free_delivery_over_amount_status = BusinessSetting::where(['key' => 'free_delivery_over_amount_status'])->first();
        if ($free_delivery_over_amount_status) {
            $free_delivery_over_amount_status->value = $status;
            $free_delivery_over_amount_status->save();
        }

        $free_delivery_over_amount = BusinessSetting::where(['key' => 'free_delivery_over_amount'])->first();
        if ($free_delivery_over_amount) {
            $free_delivery_over_amount->value = $request['free_delivery_over_amount'];
            $free_delivery_over_amount->save();
        }
