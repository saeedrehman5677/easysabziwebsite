...
--
-- Host: localhost:3306
-- Generation Time: Sep 17, 2024 at 04:39 AM
...
(1, 'Test Banner', '2023-10-18-652fd17b82b49.png', NULL, 1, '2023-10-17 19:37:15', '2023-10-17 19:37:15', 1);
...
(6, 'mail_config', '{\"status\":0,\"name\":\"Delivery APP\",\"host\":\"mail.demo.com\",\"driver\":\"smtp\",\"port\":\"587\",\"username\":\"info@demo.com\",\"email_id\":\"info@demo.com\",\"encryption\":\"tls\",\"password\":\"demo\"}', NULL, '2024-09-16 10:43:37'),
...
(104, 'maintenance_system_setup', '[]', NULL, NULL),
(105, 'maintenance_duration_setup', '{\"maintenance_duration\":\"until_change\",\"start_date\":null,\"end_date\":null}', NULL, NULL),
(106, 'maintenance_message_setup', '{\"business_number\":1,\"business_email\":1,\"maintenance_message\":\"We are Cooking Up Something Special!\",\"message_body\":\"Our system is currently undergoing maintenance to bring you an even tastier experience. Hang tight while we make the dishes.\"}', NULL, NULL),
(107, 'product_weight_unit', 'kg', NULL, NULL),
(108, 'google_map_status', '1', NULL, NULL),
(109, 'admin_order_notification', '1', NULL, NULL),
(110, 'admin_order_notification_type', 'manual', NULL, NULL);
...
(1, 'Test Category', 0, 0, 1, '2023-10-17 19:36:43', '2023-10-17 19:36:43', '2023-10-18-652fd15b117f7.png', 1),
...
INSERT INTO `delivery_charge_setups` (`id`, `branch_id`, `delivery_charge_type`, `delivery_charge_per_kilometer`, `minimum_delivery_charge`, `minimum_distance_for_free_delivery`, `fixed_delivery_charge`, `created_at`, `updated_at`) VALUES
(1, 1, 'fixed', 0, 0, 0, 100, '2024-09-16 10:43:38', '2024-09-16 10:43:38');
...
(1, 'email_verification', '0', '2024-09-16 10:43:38', '2024-09-16 10:43:38'),
(2, 'phone_verification', '0', '2024-09-16 10:43:38', '2024-09-16 10:43:38'),
(3, 'login_options', '{\"manual_login\":1,\"otp_login\":0,\"social_media_login\":0}', '2024-09-16 10:43:38', '2024-09-16 10:43:38'),
(4, 'social_media_for_login', '{\"google\":0,\"facebook\":0,\"apple\":0}', '2024-09-16 10:43:38', '2024-09-16 10:43:38');
...
(160, '2024_08_07_110744_create_table_login_setups', 61),
(161, '2024_08_12_103609_create_delivery_charge_setups_table', 61),
(162, '2024_08_12_104831_create_delivery_charge_by_areas_table', 61),
(163, '2024_08_26_112516_create_order_areas_table', 61),
(164, '2024_08_26_131235_add_weight_in_products_table', 61),
(165, '2024_08_28_132653_create_weight_settings_table', 61),
(166, '2024_09_03_133620_add_weight_charge_amount_to_orders_table', 61),
(167, '2024_09_17_103548_add_type_in_weight_settings_table', 62);
...
CREATE TABLE `orders` (
  ...
  `payment_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `free_delivery_amount` double(8,2) NOT NULL DEFAULT '0.00',
  `weight_charge_amount` double(8,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_details` (
  ...
  `unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pc',
  `is_stock_decreased` tinyint(1) NOT NULL DEFAULT '1',
  `time_slot_id` bigint DEFAULT NULL,
  `delivery_date` date DEFAULT NULL,
  `vat_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'excluded' COMMENT 'included/excluded'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `products` (`id`, `name`, `description`, `image`, `price`, `variations`, `tax`, `status`, `created_at`, `updated_at`, `attributes`, `category_ids`, `choice_options`, `discount`, `discount_type`, `tax_type`, `unit`, `total_stock`, `capacity`, `daily_needs`, `popularity_count`, `is_featured`, `view_count`, `maximum_order_quantity`, `weight`) VALUES
(1, 'Test Product', 'Test product description', '[\"2023-10-18-652fd303e4f34.png\"]', 100, '[]', 0.00, 1, '2023-10-17 19:43:47', '2023-10-17 19:57:45', '[]', '[{\"id\":\"1\",\"position\":1},{\"id\":\"2\",\"position\":2}]', '[]', 0.00, 'percent', 'percent', 'kg', 50, 1.00, 0, 0, 0, 0, 10, 0.00);
...
CREATE TABLE `register_devices` (
  ...
  `is_robot` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `users` (
  ...
  `login_medium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
...
ALTER TABLE `weight_settings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `weight_settings_branch_id_index` (`branch_id`);
