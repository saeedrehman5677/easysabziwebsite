    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.business-settings.page-setup.cancellation-policy')}}" method="post" id="cancellation_policy-form">
                    @csrf
                    <div class="form-group">
                        <div id="editor" class="min-h-116px">{!! $data['value'] !!}</div>
                        <textarea name="cancellation_policy" id="hiddenArea" style="display:none;"></textarea>
                    </div>
