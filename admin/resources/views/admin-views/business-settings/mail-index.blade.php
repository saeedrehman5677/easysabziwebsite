                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="custom--switch">
                                <input type="checkbox" name="status" value="" id="switch6" switch="primary"
                                       data-route="{{route('admin.business-settings.web-app.mail-config.status',[$status])}}"
                                    class="toggle-switch-input mail-status-change" id="stocksCheckbox{{ 1 }}" {{ $data['status'] ==  1 ? 'checked' : '' }}>
                            ...
                            @if(isset($config))
                                ...
                                <div class="btn--container justify-content-end">
                                    ...
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            class="btn btn-primary mt-2 mb-2 call-demo">{{translate('save')}}
                                    </button>
                                </div>
                            @else
