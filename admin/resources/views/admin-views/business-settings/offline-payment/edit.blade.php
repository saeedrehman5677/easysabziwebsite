                ...
                <div class="card card-body mb-3">
                    ...
                    <div id="method-field">
                        @foreach($method['method_fields'] as $key=>$field)
                            @if($key>0)
                                <div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-payment" id="field-row--{{$key}}">
                                    <div class="flex-grow-1">
                                        <div>
                                            <label class="input-label">{{translate('Title')}} </label>
                                            <input type="text" name="field_name[]" class="form-control" maxlength="255"
                                    ...
                                    <div class="" data-toggle="tooltip" data-placement="top" title="{{translate('Remove the input field')}}">
                                        <div class="action-btn btn--danger btn-outline-danger delete" onclick="delete_input_field({{$key}})">
                ...
                <div class="card card-body mb-3">
                    <div class="d-flex align-items-end gap-3 mb-4">
                        <div class="flex-grow-1">
                            ...
                            <textarea name="payment_note" class="form-control" placeholder="{{ translate('Payment Note') }}"  data-toggle="tooltip" title="Field is not editable"
                                       id="payment_note" style="background-color: #e9ecef;" readonly>{{ $method['payment_note'] }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-customer">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-10 mb-2">
                                    <input class="custom-control mr-1" type="checkbox" name="information_required[]"  {{$information['information_required'] ? 'checked' : ''}}>
                    ...
                    <div id="information-field">
                        @foreach($method['method_informations'] as $key=>$information)
                            @if($key>0)
                                <div class="d-flex align-items-end gap-3 mb-4 flex-wrap field-row-customer" id="information-row--{{ $key }}">
                                    <div class="flex-grow-1">
                                        <div class="">
                                            <label class="input-label">{{translate('Input Field Name')}} </label>
                                            <input type="text" name="information_name[]" class="form-control" maxlength="255"
                                    ...
                                    <div class="" data-toggle="tooltip" data-placement="top" title="{{translate('Remove the input field')}}">
                                        <div class="action-btn btn--danger btn btn-outline-danger delete" onclick="delete_information_input_field({{ $key }})">
                                            <i class="tio-delete-outlined"></i>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-3">
                        <button type="button" data-dismiss="modal" class="btn btn--secondary">{{ translate('Close') }}</button>
                    </div>
                </div>
            </div>
        </div>
