        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{asset('public/assets/admin/img/social.png')}}" class="w--26" alt="{{ translate('social') }}">
                </span>
                <span>
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="btn--container justify-content-end mt-3">
                        ...
                        <button id="add" class="btn btn--primary">{{ translate('submit')}}</button>
                        <a id="update" class="btn btn--primary"
                        style="display: none; ">{{ translate('update')}}</a>
                    </div>
                </form>
            </div>
        </div>
