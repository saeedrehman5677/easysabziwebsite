                    ...
                    <td class="p-0 text-left">
                        <table>
                            <tr>
                                ...
                                <td class="p-0" style="padding: 3px 0;text-transform:capitalize">: {{ $data['duration'] }}</td>
                            </tr>
                        </table>
                    </td>
                    <td>&nbsp;</td>
            ...
            <table class="bs-0 __product-table inter">
                ...
                <tr>
                    ...
                    <td class="text-right" style="padding: 3px 0;">
                        {{ Helpers::set_symbol($data['total_expense']) }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-right" style="padding: 3px 0;">
                        {{ Helpers::set_symbol($data['free_delivery']) }}
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-right" style="padding: 3px 0;">
                        {{ Helpers::set_symbol($data['coupon_discount']) }}
                    </td>
                </tr>
                <tr>
                    <td class="text-center">3</td>
                    <td>{{translate('Extra_Discount_Amount')}}</td>
                    <td class="text-right" style="padding: 3px 0;">
                        {{ Helpers::set_symbol($data['extra_discount']) }}
                    </td>
                </tr>
                </tbody>
            </table>
