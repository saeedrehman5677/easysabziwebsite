                        ...
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            <div class="uploadDnD">
                                <div class="form-group inputDnD mb-3">
                                    <input type="file" name="file_upload" class="form-control-file text--primary font-weight-bold input-file"
...
@push('script_2')
    ...
    <script src="{{ asset('public/assets/admin/js/addon.js') }}"></script>
