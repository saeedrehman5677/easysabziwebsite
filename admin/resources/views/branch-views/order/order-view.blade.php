                                        ...
                                        @if($order['order_status']=='out_for_delivery')
                                            ...
                                            @if(isset($origin))
                                                <a class="btn btn-outline-info font-semibold" target="_blank"
                                                   title="{{ translate('Deliveryman Last Location') }}" data-toggle="tooltip" data-placement="top"
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            @if(isset($order->customer) )
                                <div class="media align-items-center deco-none customer--information-single">
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img" src="{{$order->customer->imageFullPath}}" alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                                    <span class="fz--14px text--title font-semibold text-hover-primary d-block">
                     ...
                     <div class="card mt-2">
                                <div class="card-body">
                                    ...
                                    <div class="media align-items-center deco-none resturant--information-single">
                                        <div class="avatar avatar-circle">
                                            <img class="avatar-img w-75px" src="{{$order->branch?->imageFullPath}}" alt="Image Description">
                                        </div>
