...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('branch.orders.list',['pending'])}}">
        ...
        <img src="{{asset('/public/assets/admin/img/dashboard/pending.png')}}" alt="{{ translate('pending')  }}" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('branch.orders.list',['confirmed'])}}">
        ...
        <img src="{{asset('/public/assets/admin/img/dashboard/confirmed.png')}}" alt="{{ translate('confirmed')  }}" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('branch.orders.list',['processing'])}}">
        ...
        <img src="{{asset('/public/assets/admin/img/dashboard/packaging.png')}}" alt="{{ translate('packaging')  }}" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="dashboard--card h-100" href="{{route('branch.orders.list',['out_for_delivery'])}}">
        ...
        <img src="{{asset('/public/assets/admin/img/dashboard/out-for-delivery.png')}}" alt="{{ translate('out_for_delivery')  }}" class="dashboard-icon">
    </a>
</div>
...
<div class="col-sm-6 col-lg-3">
    <a class="order--card h-100" href="{{route('branch.orders.list',['failed'])}}">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                <img src="{{asset('public/assets/admin/img/delivery/4.png')}}" alt="{{ translate('failed')  }}" class="oder--card-icon">
