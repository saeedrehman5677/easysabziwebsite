    ...
    <tr>
        <td class="main-table-td">
            ...
            @if($branch->status == 1)
                ...
                <div class="mb-2">{{ translate('Admin has open your branch. you can login to panel and your branch will be shown in the customer app or website') }}</div>
            ...
            @if($branch->status == 0)
                ...
                <div class="mb-1">{{ translate('Hi') }} {{ $branch->name?? '' }},</div>
                <div class="mb-2">{{ translate('Admin has closed your branch. you cannot login to panel and your branch will not be shown in the customer app or website') }}</div>
