    ...
    <tr>
        <td class="main-table-td">
            ...
            @if($user->is_block == 0)
                ...
                <div class="mb-2">{{ translate('Admin has reopened your account. you cannot login to app and can operate any action in the app') }}</div>
            ...
            @if($user->is_block == 1)
                ...
                <div class="mb-1">{{ translate('Hi') }} {{ $user->f_name. ' '. $user->l_name }},</div>
                <div class="mb-2">{{ translate('Admin has suspended your account. you cannot login to app and cannot operate any action in the app') }}</div>
